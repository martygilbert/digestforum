...
$string['configmaxsummary'] = 'The maximum number of characters in the forum summary emailed to digest users before truncating the post and adding the "Read more" link';
...
$string['maxsummary'] = 'Max chars in post summary';
