...
$string['alldigestforums'] = 'All forums';
...
$string['blogdigestforum'] = 'Standard forum displayed in a blog-like format';
...
$string['cannotaddteacherdigestforumto'] = 'Could not add converted teacher forum instance to section 0 in the course';
...
$string['cannotdeletedigestforummodule'] = 'You can not delete the forum module.';
...
$string['cannotfindorcreatedigestforum'] = 'Could not find or create a main news forum for the site';
$string['cannotfindparentpost'] = 'Could not find top parent of post {$a}';
$string['cannotmovefromsingledigestforum'] = 'Cannot move discussion from a simple single discussion forum';
...
$string['cannotmovetosingledigestforum'] = 'Cannot move discussion to a simple single discussion forum';
...
$string['configlongpost'] = 'Any post over this length (in characters not including HTML) is considered long. Posts displayed on the site front page, social format course pages, or user profiles are shortened to a natural break somewhere between the forum_shortpost and forum_longpost values.<br />This is also the maximum number of characters in the forum summary emailed to digest users before truncating the post and adding the "Read more" link';
...
$string['configshortpost'] = 'Any post under this length (in characters not including HTML) is considered short (see below) and will be included as-is in summary emails.';
...
$string['discussionmovedpost'] = 'This discussion has been moved to <a href="{$a->discusshref}">here</a> in the forum <a href="{$a->digestforumhref}">{$a->digestforumname}</a>';
...
$string['digestforum:addinstance'] = 'Add a new forum';
...
$string['digestforumtype'] = 'Forum type';
$string['digestforumtype_help'] = 'There are 5 forum types:
...
$string['generaldigestforum'] = 'Standard forum for general use';
$string['generaldigestforums'] = 'General forums';
...
$string['invaliddigestforumid'] = 'Forum ID was incorrect';
$string['invalidparentpostid'] = 'Parent post ID was incorrect';
$string['invalidpostid'] = 'Invalid post ID - {$a}';
$string['lastpost'] = 'Last post';
$string['learningdigestforums'] = 'Learning forums';
...
$string['newdigestforumposts'] = 'New forum posts';
...
$string['nopostdigestforum'] = 'Sorry, you are not allowed to post to this forum';
...
$string['page-mod-digestforum-x'] = 'Any forum module page';
$string['page-mod-digestforum-view'] = 'Forum module main page';
$string['page-mod-digestforum-discuss'] = 'Forum module discussion thread page';
...
$string['posttodigestforum'] = 'Post to forum';
...
$string['qandadigestforum'] = 'Q and A forum';
...
$string['reply'] = 'Reply';
$string['replydigestforum'] = 'Reply to forum';
...
$string['searchdigestforums'] = 'Search forums';
...
$string['searchwhichdigestforums'] = 'Choose which forums to search';
...
$string['thisdigestforumisthrottled'] = 'This forum has a limit to the number of forum postings you can make in a given time period - this is currently set at {$a->blockafter} posting(s) in {$a->blockperiod}';
