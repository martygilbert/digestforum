...
$string['configdigestforum_maildelay'] = 'Coupled with the following setting, Moodle with pause this number of seconds after sending the below number of emails. The purpose it to (hopefully) not overload the email server if you have a large number of participants receiving this digest forum email.';
$string['configdigestforum_maildelaynum'] = 'Digest forum will pause digestforum_maildelay seconds after this number of emails sent.'; 
...
$string['digestforum_maildelay'] = 'Time (in seconds) to delay when sending digest emails';
$string['digestforum_maildelaynum'] = 'Insert delay after this many emails';
