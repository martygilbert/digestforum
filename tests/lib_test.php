...
class mod_digestforum_lib_testcase extends advanced_testcase {
    ...
    public function test_digestforum_tp_can_track_digestforums() {
        ...
        $useron = $this->getDataGenerator()->create_user(array('trackdigestforums' => 1));
        $useroff = $this->getDataGenerator()->create_user(array('trackdigestforums' => 0));
        $course = $this->getDataGenerator()->create_course();
    ...
    public function test_print_overview() {
        ...
        $viewer = self::getDataGenerator()->create_user((object) array('trackdigestforums' => 1));
    ...
    public function test_print_overview_groups() {
        ...
        $viewer1 = self::getDataGenerator()->create_user((object) array('trackdigestforums' => 1));
        ...
        $viewer2 = self::getDataGenerator()->create_user((object) array('trackdigestforums' => 1));
    ...
    public function test_pinned_discussion_with_group() {
        ...
        $viewer1 = $this->getDataGenerator()->create_user((object) array('trackdigestforums' => 1));
        $this->getDataGenerator()->enrol_user($viewer1->id, $course1->id);

        $viewer2 = $this->getDataGenerator()->create_user((object) array('trackdigestforums' => 1));
        $this->getDataGenerator()->enrol_user($viewer2->id, $course1->id);
