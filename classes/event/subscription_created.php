 ...
 *
 *      - int digestforumid: The id of the digestforum which has been subscribed to.
 * }
 *
 * @package    mod_digestforum
 * @since      Moodle 2.7
...
class subscription_created extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' subscribed the user with id '$this->relateduserid' to the digestforum with " .
    ...
    public static function get_name() {
        return get_string('eventsubscriptioncreated', 'mod_digestforum');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'digestforum', 'subscribe', 'view.php?f=' . $this->other['digestforumid'],
