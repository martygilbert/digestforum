...
/**
 * The mod_digestforum post created event.
 *
...
/**
 * The mod_digestforum post created event class.
 *
...
class post_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostcreated', 'mod_digestforum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'digestforum', 'add post', $logurl, $this->other['digestforumid'], $this->contextinstanceid);
    }
