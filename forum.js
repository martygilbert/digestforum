...
function digestforum_produce_subscribe_link(digestforumid, backtoindex, ltext, ltitle) {
    var elementid = "subscriptionlink";
    var subs_link = document.getElementById(elementid);
    if(subs_link){
        subs_link.innerHTML = "<a title='"+ltitle+"' href='"+M.cfg.wwwroot+"/mod/digestforum/subscribe.php?id="+digestforumid+backtoindex+"&amp;sesskey="+M.cfg.sesskey+"'>"+ltext+"<\/a>";
    }
}

function digestforum_produce_tracking_link(digestforumid, ltext, ltitle) {
    var elementid = "trackinglink";
    var subs_link = document.getElementById(elementid);
    if(subs_link){
        subs_link.innerHTML = "<a title='"+ltitle+"' href='"+M.cfg.wwwroot+"/mod/digestforum/settracking.php?id="+digestforumid+"&amp;sesskey="+M.cfg.sesskey+"'>"+ltext+"<\/a>";
    }
}
