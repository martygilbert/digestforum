...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('digestmailtime', get_string('digestmailtime', 'digestforum'),
                       get_string('configdigestmailtime', 'digestforum'), 17, $options));
